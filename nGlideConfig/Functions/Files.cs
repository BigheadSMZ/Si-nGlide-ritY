...
namespace nGlideConfig
{
    ...
    *---------------------------------------------------------------------------------------------------------------------------------*/
    ...
    public class FileEx
    {
       ...
       /*===================================================================================================================================
        * Works as expected except that it removes the file before writing instead of trying to overwrite it.
        *---------------------------------------------------------------------------------------------------------------------------------*/
        public static void WriteAllBytes(string FilePath, byte[] Bytes)
        {
            // If the path exists, remove it before writing the file.
        ...
        *---------------------------------------------------------------------------------------------------------------------------------*/
        public static string ExtensionToText(string Extension)
        {
            // Trim the period and force the string to uppercase.
            return Extension.TrimStart('.').ToUpper();
        }
       /*===================================================================================================================================
        * Takes a capitalized word (PNG/DDS/JPG/TGA/TIFF) and returns it as a file extension (.png/.dds/.jpg).
        *---------------------------------------------------------------------------------------------------------------------------------*/
        public static string TextToExtension(string Text)
        {
            // Add a period and force it to lowercase.
            return "." + Text.ToLower();
        }
       /*===================================================================================================================================
        * Reads a text file into a List<string> array rather than a string[] array.
        *---------------------------------------------------------------------------------------------------------------------------------*/
        public static List<string> ReadLinesToList(string FilePath)
        {
            ...
            // Convert the string array to a list array.
            List<string> StringList = Strings.ArrayToList(Lines); 
